...
namespace ERP_BusinessLogic.Migrations
{
    ...
    [Migration("20230223081014_SupplierOrdersCreated")]
    partial class SupplierOrdersCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP_Domians.Models.TbOrderDetails_Supplier", b =>
                {
                    ...
                    b.ToTable("TbOrderDetails_Supplier");
                });
            ...
            modelBuilder.Entity("ERP_Domians.Models.TbOrderStatus_Supplier", b =>
                {
                    ...
                    b.ToTable("TbOrderStatus_Supplier");
                });
            ...
            modelBuilder.Entity("ERP_Domians.Models.TbSupplyOrder", b =>
                {
            ...
            modelBuilder.Entity("ERP_Domians.Models.TbSupplyOrderDetail", b =>
                {
                    b.Property<int>("SupplyOrderId")
                        .HasColumnType("int")
                        .HasColumnName("supplyOrderId");
                    ...
                    b.OwnsOne("ERP_Domians.Models.OwnedProperties.OrderedRawMaterialDetails", "OrderedRawMaterials", b1 =>
                        {
                            ...
                            b1.ToTable("TbOrderDetails_Supplier");
            ...
            modelBuilder.Entity("ERP_Domians.Models.TbSupplyOrderDetail", b =>
                {
                    ...
                    b.HasOne("ERP_Domians.Models.TbSupplyOrder", "SupplyOrder")
                        .WithMany("TbSupplyOrderDetails")
